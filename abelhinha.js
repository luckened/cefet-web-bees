...
Abelhinha.prototype.posiciona = function (tempoAtrasoParaIniciar) {
    ...
    this.yInicial =
        Math.random() * (UM_QUARTO_DA_ALTURA_DA_JANELA - ALTURA_ABELHA);
    this.yFinal =
        Math.random() * (UM_QUARTO_DA_ALTURA_DA_JANELA - ALTURA_ABELHA);
    ...
    this.tempoAtrasoParaIniciar =
        tempoAtrasoParaIniciar || Math.random() * 7000;
};
...
Abelhinha.prototype.atualiza = function (delta) {
    ...
    this.x =
        this.xInicial + this.porcentagemTrajeto * (this.xFinal - this.xInicial);
    this.y =
        this.yInicial +
        this.porcentagemTrajeto * (this.yFinal - this.yInicial) +
        Math.sin(this.porcentagemTrajeto * 4 * 3.14159) * (4 * ALTURA_ABELHA);
